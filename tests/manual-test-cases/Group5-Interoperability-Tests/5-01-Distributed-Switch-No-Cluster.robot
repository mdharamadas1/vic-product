...
Distributed Switch Setup
    ...
    Set Environment Variable  TEST_HOST  @{esx_ips}[0]

*** Test Cases ***
Test
    Deploy OVA And Install UI Plugin And Run Regression Tests  5-01-TEST  vic-*.ova  %{TEST_DATASTORE}  %{BRIDGE_NETWORK}  %{PUBLIC_NETWORK}  %{TEST_USERNAME}  %{TEST_PASSWORD}  host-ip=%{TEST_HOST}
